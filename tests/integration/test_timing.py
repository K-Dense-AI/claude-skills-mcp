...
def test_frontend_cold_start_under_cursor_timeout():
    ...
    print(f"Cursor timeout limit: 60s")
...
def test_package_sizes():
    ...
    frontend_wheel = "packages/frontend/dist/claude_skills_mcp-1.0.0-py3-none-any.whl"
    ...
    backend_wheel = "packages/backend/dist/claude_skills_mcp_backend-1.0.0-py3-none-any.whl"
